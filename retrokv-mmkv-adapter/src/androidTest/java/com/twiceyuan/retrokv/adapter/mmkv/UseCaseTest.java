...
import com.twiceyuan.retrokv.adapter.mmkv.storage.Settings;
...
public class UseCaseTest {
    ...
    public void useAppContext() {
        ...
        mmkv = MMKV.mmkvWithID(Settings.class.getSimpleName());
    }
    ...
    public void testParcelable() {
        mSettings.userModel().set(new MockUser("twiceYuan", 1000));
        MockUser user = mSettings.userModel().get();
        Assert.assertNotNull(user);
        Assert.assertEquals(user.getUsername(), "twiceYuan");
